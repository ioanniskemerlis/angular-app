  ...
  menuItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Tuna salad', description: 'Apples , red onion, sweet balsamic , sweetcorn , cherry tomatoes and walnuts, lettuce & tomatoes', price: '€15,80' },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Vodka Chicken Margherita', description: 'With Corn Crispy Chicken Strips , topped with parmensan', price: '€18,80' },
        ...
        { name: 'Vodka Chicken Parmigiana', description: 'VODKA Chicken Parm, served with Spaghetti', price: '€20,80' },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Fresh Octopus Linguine', description: 'Octopus Linguine in garlic and Chili , Tomato based sauce with red wine', price: '€21,80' },
        ...
        { name: 'Mussels and Cream Risotto', description: 'Topped with Napoli tomato sauce', price: '€22,80' },
      ],
    },
    {
