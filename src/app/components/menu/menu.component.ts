  ...
  menuItems = [
    {
      ...
      items: [
        ...
        { name: 'Steamed Mussels', description: 'Fresh mussels from the Greek sea, served with ouzo sauce and fresh herbs.', price: '€16,80'},
        ...
        { name: 'Potatoes Baby', description: 'Baby butter potatoes served with garlic oil, sea salt and fresh herbs.', price: '€6,00', isVegan: true },
        { name: 'Potatoes Bravas', description: 'Crispy fried potatoes with tomato aromatic sauce, sour cream, minced meat and chives.', price: '€6,00', isVegan: true },
        { name: 'Shrimp Kataifi', description: 'Two classic flavours from land of the sun. Fresh shrimps wrapped with crunchy kataifi, served with spicy sauce.', price: '€6,00', isVegan: true },
        { name: 'Octopus with Split Peas', description: 'Slow cooked Fresh octopus, served with creamy split peas and chives oil.', price: '€6,00', isVegan: true },
      ],
    },
    {
      category: 'Salads',
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Traditional Wild Boar Pancetta', description: 'Recipe from our mountains, slow cooked pork pancetta, served with mashed potatoes and caramelised sauce.', price: '€13,80' },
