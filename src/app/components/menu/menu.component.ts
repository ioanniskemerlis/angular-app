  ...
  menuItems = [
    {
      ...
      items: [
        ...
        { name: 'Tzatziki Local Recipe', description: 'Tzatziki with a Corfu Local Fuse Touch , Served with Local baked Bread', price: '€8,80' , isVegan: true},
        ...
        { name: 'Bruschetta Mediterranean', description: 'All time classic dish served with fresh tomato sauce, burrata cheese, prosciutto slices and fresh herbs.', price: '€9,50' },
        ...
        { name: 'Baby Potatoes', description: 'Baby butter potatoes served with garlic oil, sea salt and fresh herbs.', price: '€8,50', isVegan: true },
        { name: 'Patatas Bravas', description: 'Crispy fried potatoes with tomato aromatic sauce, sour cream, minced meat and chives.', price: '€9,50', isVegan: true },
        { name: 'Shrimp Kataifi', description: 'Two classic flavours from land of the sun. Fresh shrimps wrapped with crunchy kataifi, served with spicy sauce.', price: '€16,80', isVegan: true },
        { name: 'Octopus with Split Peas', description: 'Slow cooked Fresh octopus, served with creamy split peas and chives oil.', price: '€17,20', isVegan: true },
      ],
    },
    {
      category: 'Salads',
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Raviolli Dimare', description: 'Black pasta  with cuttlefish ink, stuffed with fresh shrimps served with aromatic white sauce and ouzo. ', price: '€16,80' },
        { name: 'Bolognese casarecce', description: 'Italian style slow cooked minced meat with tomato sauce, served with pasta casarecce.', price: '€18,80' },
        { name: 'Carbonara', description: 'Old school carbonara recipe, with fresh guanciale, pecorino cheese and egg yolks, served with spaghetti.', price: '€18,80' },
        { name: 'Carbonara Nduje', description: 'Nduje pappardelle carbonara, an Italian icon spicy edition. Served with parmigiano reggiano, pecorino, egg yolks and black pepper.', price: '€18,80' },
      ],
    },
    // {
    ...
    // },
    {
      ...
      items: [
        ...
        { name: 'Vodka Porketta Parmigiano', description: 'Vodka pork parm, served with creamy sauce and spaghetti.', price: '€20,80' },
      ],
    },
    {
      category: 'Chicken Dishes',
      items: [
        { name: 'Chicken thigh fillet', description: 'Marinated chicken fillets and sea salt, served with butter baby potatoes and garlic sauce.', price: '€16,80' },
        { name: 'Chicken Parm', description: 'Parmesan Heaven with crispy chicken and Pasta all Stone Baked', price: '€19,80' },
        { name: 'Chicken meatballs', description: 'Fresh chicken meatballs with traditional Corfu recipe, served  with tomato sauce and Parmesan cheese', price: '€16,80' },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Moussaka', description: 'The Greek way to say I love you. Traditional moussaka recipe served with fresh vegetables, minced meat and feta cheese.', price: '€13,80' },
        { name: 'Traditional Black Pork Pancetta', description: 'Recipe from our mountains, slow cooked pork pancetta, served with mashed potatoes and caramelised sauce.', price: '€13,80' },
        { name: 'Wild Boar Stifado', description: 'An old Greek recipe with slow cooked wild boar, baby onions tomato sauce and herbs.', price: '€23,80' },
        { name: 'Local Sofrito Beef', description: 'Local Beef Sofrito Stone Baked Recipe , its a must try dish in Corfu', price: '€19,80' },
        { name: 'Spaghetti & Meat balls (Soutzoukakia)', description: '', price: '€19,50' },
        { name: 'Local Mixed Stoned Baked Original Paella for 1... Or 2...', description: 'Healthy and fresh seafood dish, served with aromatic rice, squid, mussels, shrimps and chicken fillet.', price: '€35,50 / €48,50' },
      ],
    },
    {
      ...
      items: [
        ...
        { name: 'Sea Bream Fillet', description: 'Fresh sea bream with butter Asparagus. Served with mashed potatoes', price: '€22,80' },
      ],
    },
    {
      ...
      items: [
        ...
        { name: 'Vegan Saganaki', description: 'The classic flavour in vegan edition, fresh vegetables, eggplant, tomato juice and vegan feta cheese, served with fresh bread.', price: '€9,80', isVegan: true },
        ...
        { name: 'Spagheti Napoli', description: 'Served with cherry tomatoes and fresh oregano.', price: '€10,80', isVegan: true },
        { name: 'Spaghetti & Meat balls (Soutzoukakia)', description: '', price: '€18,50', isVegan: true },
        { name: 'Vegan Carbonara', description: 'Served with spaghetti, creamy sauce and vegan bacon bits.', price: '€21,80', isVegan: true },
      ],
    },
    {
      category: 'Desserts',
      items: [
        { name: 'Tiramisu', description: 'With coffee flavours and creamy texture.', price: '€7,50' },
        { name: 'Orange Pie', description: 'Traditional orange pie served with vanilla ice cream and caramelised pecan.', price: '€8,50' },
        { name: 'Popcorn Wafer Tart', description: 'Served with namelaka milk chocolate, white chocolate cream and popcorn wafer.	', price: '€9,20' },
        { name: 'Baclava', description: 'Traditional Baklava recipes ( with vanilla ice cream + 2€ )', price: '€8,50' },
      ],
    },
    {
      category: 'Wines',
